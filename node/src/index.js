...
const getImportDetails = async (id) => {
  ...
  console.log(
    'Calling hubspotClient.crm.imports.coreApi.getById. Retrieve a import details by id:',
    id
  );
...
app.get('/imports', async (req, res) => {
  try {
    ...
    console.log(
      'Calling hubspotClient.crm.imports.coreApi.getPage. Get imports page.'
    );
...
app.post('/imports', async (req, res) => {
  try {
    ...
    // https://developers.hubspot.com/docs/api/crm/imports
    console.log(
      'Calling crm.imports.coreApi.create API method. Starting a new import'
    );
    const result = await hubspotClient.crm.imports.coreApi.create(
      file,
...
app.get('/imports/:id/cancel', async (req, res) => {
  try {
    ...
    // https://developers.hubspot.com/docs/api/crm/imports
    console.log(
      'Calling hubspotClient.crm.imports.coreApi.cancel. Cancel import by id:',
      id
    );
    const importCancelResponse = await hubspotClient.crm.imports.coreApi.cancel(
      id
    );
